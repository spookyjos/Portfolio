            ...
            <div className="space-y-10 border-l border-neutral-800 pl-8">
              ...
              <div>
                ...
                <p className="mt-3 text-slate-400 text-sm">
                  Worked under the National Cyber Threat Monitoring Centre for a period of 2 years. Aided in filtering and disseminating relevant information and actionable items to stakeholders in the Singapore Critical Information Infrastructure with urgency. Also triaged logs to identify whether they should be escalated or dropped. 
                </p>
              </div>
